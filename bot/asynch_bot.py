...
def start(message):
    ...
    if message.text == '/start':
        ...
        async def send_welcome():
            await message.reply(client_id, "Здравствуйте. Как Вас зовут?")
...
if __name__ == '__main__':
   dp.start_polling(my_bot, skip_updates=True)